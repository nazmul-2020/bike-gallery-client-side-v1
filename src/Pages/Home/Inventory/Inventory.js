...
const Inventory = () => {
    ...
    return (
        ...
        <div className='my-3 inventory-container container '>
            ...
            <button type="button" className="btn btn-dark  mx-auto my-5 d-flex"><Link to='/allInventory' className=' text-decoration-none text-white'> Manage All Inventories</Link></button>
        </div>
